...
L:RegisterTranslations("enUS", function() return {
		...
		["/ksj"] = true,
		["options"] = true,
		["Mostrar painel de opções."] = true,
		["add"] = true,
		["Adicionar itens à lista de ignorados global."] = true,
		["<item link>[<item link>...]"] = true,
		["rem"] = true,
		["Remover itens da lista global de ignorados."] = true,
		["me"] = true,
		["Adicionar ou remover um item da lista de exceções."] = true,
		["list"] = true,
		["Listar exceções."] = true,
